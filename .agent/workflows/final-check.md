...
4. Utilize CSS and variables to unify designs and improve efficiency by modularizing designs.
5.When releasing this service to the public, potential security risks such as XSS and overflows will be carefully examined and addressed.
6. List all the functions of this tool, compare them with the contents of README.md, the manual, and About, and update any inconsistencies or missing information.